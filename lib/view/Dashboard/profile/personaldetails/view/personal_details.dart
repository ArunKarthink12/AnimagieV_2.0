...
class _PersonalDetailsState extends State<PersonalDetails> {
  PersonalDetailsController personalDetailsController =
      Get.put(PersonalDetailsController()); // var _selectedGender;
  ...
  void initState() {
    ...
    Future.delayed(Duration.zero, () async {
      await personalDetailsController.personalDetailsControl();
    });
    super.initState();
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Obx(() {
        if (personalDetailsController.loadingindicator.isFalse) {
          return Center(
            child: CircularProgressIndicator(),
          );
        } else if (personalDetailsController.doctorDetailsList.isEmpty) {
          return Center(
            child: Text("No Dataas"),
          );
        } else {
          return Container(
