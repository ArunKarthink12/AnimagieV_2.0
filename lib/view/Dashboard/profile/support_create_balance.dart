...
class SupportCreateBalance extends StatefulWidget {
  const SupportCreateBalance({super.key});

  @override
  State<SupportCreateBalance> createState() => _SupportState();
}

class _SupportState extends State<SupportCreateBalance> {
  var newteredlist = [
    'Appointments',
    'Others',
  ];
