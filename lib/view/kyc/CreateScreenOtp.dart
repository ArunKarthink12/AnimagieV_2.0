...
class CreateScreenOTP extends StatefulWidget {
  const CreateScreenOTP({Key? key}) : super(key: key);

  @override
  State<CreateScreenOTP> createState() => _CreateScreenOTPState();
}

class _CreateScreenOTPState extends State<CreateScreenOTP> {
  bool hasError = false;
  String currentText = "";
