...
class DoctorUpdateSlotsService {
  Future doctorUpdateSlotsServiceFunction() async {
    try {
      ...
      var response = await http.post(
        Uri.parse(Urls.doctorUpdateSlots),
      ...
      if (response.statusCode == 200) {
        ...
        return DoctorUpdateSlotsModel.fromJson(jsonresponse);
      } else {
