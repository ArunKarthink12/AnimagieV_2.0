...
KycStaticModel kycStaticModelFromJson(String str) => KycStaticModel.fromJson(json.decode(str));
...
class KycStaticModel {
    ...
    factory KycStaticModel.fromJson(Map<String, dynamic> json) => KycStaticModel(
        ...
        qualification: List<Gender>.from(json["qualification"].map((x) => Gender.fromJson(x))),
    );
