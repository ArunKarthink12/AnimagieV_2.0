...
class KycModel {
    ...
    factory KycModel.fromJson(Map<String, dynamic> json) => KycModel(
        ...
        percentageOfFilling: PercentageOfFilling.fromJson(json["percentage_of_filling"]),
    );
...
class PercentageOfFilling {
    ...
    factory PercentageOfFilling.fromJson(Map<String, dynamic> json) => PercentageOfFilling(
        percentageFilled: json["percentage_filled"]?.toDouble(),
    );
